...
class TestBiobank(unittest.TestCase):
    ...
    def test_biobank_init(self):
        ...
        self.assertEqual("juristic_person", biobank.juristic_person)
    ...
    def test_biobank_to_fhir_no_optional_args(self):
        ...
        self.assertEqual("juristic_person", biobank_fhir.extension[0].valueString)
    ...
    def test_biobank_to_fhir_with_optional_args(self):
        ...
        self.assertEqual("juristic_person", biobank_fhir.extension[3].valueString)
