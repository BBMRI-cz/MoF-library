...
class TestCondition(unittest.TestCase):
    ...
    def test_condition_init(self):
        condition = MoFCondition("patientId")
        self.assertIsInstance(condition, MoFCondition)
